                ...
                <div className="flex gap-2 mt-4">
                  ...
                  {favorite.contractor?.phone && (
                    <Button
                      ...
                      size="icon"
                      asChild
                      className="text-white/60 hover:text-green-400 hover:bg-green-400/10"
                    >
                  ...
                  {favorite.contractor?.email && (
                    <Button
                      ...
                      size="icon"
                      asChild
                      className="text-white/60 hover:text-blue-400 hover:bg-blue-400/10"
                    >
                  ...
                  {favorite.contractor?.website && (
                    <Button
                      ...
                      size="icon"
                      asChild
                      className="text-white/60 hover:text-purple-400 hover:bg-purple-400/10"
                    >
