    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Compare features across our roofing solutions. Use the quiz above to get your personalized estimate with pricing.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <CardHeader className="pb-3">
                ...
                {/* Only show price if pricePerSquare is not empty */}
                {pkg.pricePerSquare && (
              ...
              <CardContent className="space-y-4">
                ...
                <Button 
                  onClick={() => onToggleComparison(pkg)}
