...
export const AcademyHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-emerald-500/10 via-background to-emerald-600/5 py-20 md:py-32">
      {/* Background Pattern */}
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 text-emerald-600 px-4 py-2 rounded-full text-sm font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/academy/resources">
              <Button size="lg" variant="outline" className="text-lg px-8 border-emerald-600/30 hover:bg-emerald-500/10 hover:border-emerald-600">
          ...
          <div className="grid grid-cols-3 gap-8 pt-12 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-emerald-600">8</div>
