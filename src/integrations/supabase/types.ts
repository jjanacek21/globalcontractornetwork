    ...
    Tables: {
      ...
      rs_ai_analyses: {
        Row: {
          ...
          id: string
          is_storm_damage: boolean | null
          photo_urls: string[] | null
          storm_damage_type: string | null
          storm_lookup_results: Json | null
        }
        Insert: {
          analysis_results?: Json | null
          company_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "rs_ai_analyses_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "rs_company_profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "rs_ai_analyses_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "rs_customers"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "rs_ai_analyses_estimate_id_fkey"
            columns: ["estimate_id"]
            isOneToOne: false
            referencedRelation: "rs_estimates"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      rs_customers: {
        ...
        Relationships: [
          {
            foreignKeyName: "rs_customers_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "rs_company_profiles"
            referencedColumns: ["id"]
      ...
      rs_estimate_line_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "rs_estimate_line_items_estimate_id_fkey"
            columns: ["estimate_id"]
            isOneToOne: false
            referencedRelation: "rs_estimates"
            referencedColumns: ["id"]
      ...
      rs_estimates: {
        Row: {
          code_requirements: Json | null
          company_id: string
          created_at: string | null
          customer_id: string | null
          decking: Json | null
          disclaimer: string | null
          drip_edge: boolean | null
          engineering_cost: number | null
          engineering_required: boolean | null
          estimate_number: string
          existing_condition: string | null
          existing_layers: number | null
          existing_roof_type: string | null
          fascia_repair: string | null
          grand_total: number | null
          gutters: Json | null
          id: string
          known_issues: string[] | null
          linear_measurements: Json | null
          new_roof_details: Json | null
          new_roof_type: string | null
          notes: string | null
          num_facets: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "rs_estimates_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "rs_company_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rs_estimates_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "rs_customers"
            referencedColumns: ["id"]
      ...
      rs_line_item_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "rs_line_item_templates_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "rs_company_profiles"
            referencedColumns: ["id"]
