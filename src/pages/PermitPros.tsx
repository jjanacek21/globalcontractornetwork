        ...
        <div className="container relative">
          <div className="mx-auto max-w-4xl text-center space-y-8">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              ...
              Permit Pros takes the hassle out of Florida building permits.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                ...
                <span className="text-amber-500">Permit Pros</span>
              </h2>
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-600/20 border border-amber-500/30 p-12 text-center">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
              Join hundreds of Florida contractors who trust Permit Pros to handle their permitting needs. 
