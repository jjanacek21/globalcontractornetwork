...
.gcn-home .nav{display:flex;align-items:center;justify-content:space-between;gap:18px;min-height:96px}.gcn-home .brand{position:relative;display:flex;align-self:stretch;width:260px;flex:none}.gcn-home .animated-logo{position:relative;display:block;width:260px;aspect-ratio:16/9;overflow:visible;isolation:isolate;-webkit-mask-image:radial-gradient(ellipse 100% 100% at center,#000 78%,transparent 100%);mask-image:radial-gradient(ellipse 100% 100% at center,#000 78%,transparent 100%)}.gcn-home .animated-logo::before{content:"";position:absolute;inset:8% 3%;z-index:-1;background:radial-gradient(ellipse at center,var(--gcn-ground-2),transparent 72%);filter:blur(18px);border-radius:50%;opacity:.5}.gcn-home .animated-logo video,.gcn-home .animated-logo img{width:100%;height:100%;display:block;object-fit:contain;object-position:center;mix-blend-mode:screen}.gcn-home .animated-logo img{display:none}.gcn-home .brand .animated-logo{position:absolute;top:0;left:0;transform:translateY(4px);transition:transform .3s ease}.gcn-home .brand .animated-logo::before{background:radial-gradient(ellipse at center,var(--gcn-ground-2),var(--gcn-ground) 58%,transparent 76%);opacity:.72}.gcn-home .brand:hover .animated-logo{transform:translateY(4px) scale(1.025)}
