...
.gcn-home .nav{display:flex;align-items:center;justify-content:space-between;gap:18px;min-height:96px}.gcn-home .brand{display:flex;align-items:center}.gcn-home .animated-logo{position:relative;display:block;width:240px;aspect-ratio:16/6;overflow:hidden;isolation:isolate;-webkit-mask-image:radial-gradient(ellipse 88% 82% at center,#000 58%,transparent 100%);mask-image:radial-gradient(ellipse 88% 82% at center,#000 58%,transparent 100%)}.gcn-home .animated-logo::before{content:"";position:absolute;inset:5% 1%;z-index:-1;background:rgba(2,8,16,.9);filter:blur(12px);border-radius:50%}.gcn-home .animated-logo video,.gcn-home .animated-logo img{width:100%;height:100%;display:block;object-fit:cover;object-position:center}.gcn-home .animated-logo img{display:none}.gcn-home .brand .animated-logo{transition:transform .3s ease}.gcn-home .brand:hover .animated-logo{transform:scale(1.025)}
