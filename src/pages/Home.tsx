...
import gcnLogoAlphaWebmAsset from "@/assets/gcn-logo-alpha.webm.asset.json";
import gcnLogoStillAsset from "@/assets/gcn-logo-still.webp.asset.json";
...
const AnimatedLogo = () => {
  ...
  return (
    <span className="animated-logo">
      {reduceMotion ? (
        <img src={gcnLogoStillAsset.url} alt="The Global Contractor Network" />
      ) : (
        <video
          autoPlay
          muted
          ...
          playsInline
          preload="metadata"
          poster={gcnLogoStillAsset.url}
          aria-label="The Global Contractor Network"
        >
          <source src={gcnLogoAlphaWebmAsset.url} type="video/webm" />
          <img src={gcnLogoStillAsset.url} alt="The Global Contractor Network" />
        </video>
      )}
    </span>
