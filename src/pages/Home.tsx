...
.gcn-home .nav{display:flex;align-items:center;justify-content:space-between;gap:18px;min-height:96px}.gcn-home .brand{display:flex;align-items:center;align-self:stretch}.gcn-home .animated-logo{position:relative;display:block;width:240px;aspect-ratio:16/7;overflow:hidden;isolation:isolate;-webkit-mask-image:radial-gradient(ellipse 88% 88% at center,#000 58%,transparent 100%);mask-image:radial-gradient(ellipse 88% 88% at center,#000 58%,transparent 100%)}.gcn-home .animated-logo::before{content:"";position:absolute;inset:5% 1%;z-index:-1;background:rgba(2,8,16,.9);filter:blur(12px);border-radius:50%}.gcn-home .animated-logo video,.gcn-home .animated-logo img{width:100%;height:100%;display:block;object-fit:cover;object-position:center}.gcn-home .animated-logo img{display:none}.gcn-home .brand .animated-logo{transform:translateY(14px);transition:transform .3s ease}.gcn-home .brand:hover .animated-logo{transform:translateY(14px) scale(1.025)}
...
@media (max-width:760px){.gcn-home .nav{min-height:76px}.gcn-home .brand .animated-logo{width:170px;transform:translateY(10px)}.gcn-home .brand:hover .animated-logo{transform:translateY(10px) scale(1.025)}.gcn-home .nav-cta>.btn-ghost{display:none}.gcn-home .hero{padding:66px 0 76px}.gcn-home section{padding:70px 0}.gcn-home .tile-grid,.gcn-home .tools-grid,.gcn-home .ctile-grid,.gcn-home .why-grid,.gcn-home .review-grid{grid-template-columns:repeat(2,1fr)}.gcn-home .stats-grid{grid-template-columns:repeat(2,1fr)}.gcn-home .foot-grid{grid-template-columns:1fr 1fr}}
