...
.gcn-home .logo-img{height:64px;width:auto;max-width:240px;object-fit:contain;background:transparent;filter:drop-shadow(0 6px 10px rgba(122,90,20,.35));transition:transform .4s}
.gcn-home .brand:hover .logo-img{transform:scale(1.03)}
.gcn-home footer .logo-img{height:56px}
