...
const MemberDashboard = () => {
  ...
  const contractorServices: ServiceCard[] = [
    ...
    { icon: Wrench, title: "The GCN Store", description: "Spray rigs, guns, tips & parts — built for pros", link: "/equipment", badge: "New" },
  ];
  ...
  const contractorApps: ServiceCard[] = [
    ...
    { icon: Building2, title: "PropertyIQ", description: "Property intel reports, owner data & roof analysis", comingSoon: true, demoLink: "/property-iq/dashboard?demo=1" },
